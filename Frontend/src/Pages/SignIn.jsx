...
const SignIn = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const isDemo =
      String(data.email).trim().toLowerCase() === "demo@ayashtech.com" &&
      String(data.password) === "demo1234";

    toast.success(
      isDemo ? "Welcome Aman ✅" : "Signed in ✅",
      {
        position: "top-center",
        autoClose: 2000,
  ...
  const signInAsDemo = () => {
    ...
    dispatch(signIn({ email: "demo@ayashtech.com", password: "demo1234" }));

    toast.success("Welcome Aman ✅", {
      position: "top-center",
      autoClose: 2000,
      hideProgressBar: false,
      closeOnClick: false,
